...
**Project**: quick-reply-keeper 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I'm struggling to keep up with my LinkedIn messages.  I waste a lot of time writing responses.

Make a simple one page tool where I can store common responses to easily browse and copy paste back into LinkedIn. 
...
```sh
git clone https://github.com/GPT-Engineer-App/quick-reply-keeper.git
cd quick-reply-keeper
npm i
